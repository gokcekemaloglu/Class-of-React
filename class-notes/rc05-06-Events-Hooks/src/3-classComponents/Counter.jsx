...
class Counter extends Component {
  ...
  //* Bu nedenle, metodlarımızı constructor daki class a bind etmeliyiz veya automatic binding için arrow function kullanabiliriz.(bind yazmaya gerek kalmaz arrow'la)
  render() {
    return (
